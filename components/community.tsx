  ...
  return (
    <div className="flex flex-col justify-center mb-20">
      ...
      <div className="flex flex-col py-4 gap-y-2 mx-4">
        <Card className="flex flex-col items-center justify-center py-20 w-full max-w-full text-white">
          <h1 className="text-center text-4xl font-bold mb-2">Daft Blog</h1>
          <p className="text-center px-80 text-xl mb-2">
        ...
        <div className="flex gap-x-2">
          <Card className="flex justify-center py-20 w-full max-w-full">
            home
          </Card>
          <Card className="flex justify-center py-20 w-full max-w-full">
            Hello
